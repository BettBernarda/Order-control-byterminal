menuDic = {}      # Informações do menu (Numero: [nome, valor, custo])
waitingDic = {}    # Dicionário de espera pedidos para viagem, pedidos em aberto (NOME CLIENTE: [Nome Item, Valor, Custo])
invoiceSum = 0 # Lista para armazenar faturamento diário
dateIncomeDic = {} # Dicionário de valores de pedidos concluídos
custSum = 0     # Lista para armazenar custo diário
dateCustDic = {}
cashOpeningStatus = 0  # Usar 1 e 0 para determinar abertura (0=fechado, 1=aberto)
